...
int main(int argc, char *argv[]){
    ...
    long input_length, key_length;
    int socketFD, charsWritten, charsRead;

    // if less than 4 arguments entered then error msg
    if(argc < 4){
    ...
    if(socketFD < 0){ // error checking socket
